...
constexpr unsigned long long INIT {35000};
 ...
 */
void Shell::readfromfile(const QString &inputline)
{
    ...
    QRegularExpressionMatch _match = _re.match(inputline);
    if(_match.hasMatch())
    {
