...
void Dialog::on_buttonBox_rejected() { qDebug() << "Pressed Cancel"; }

void Dialog::on_Dialog_accepted() { qDebug() << "Pressed OK"; }

void Dialog::on_Dialog_rejected() { qDebug() << "Pressed Cancel"; }
