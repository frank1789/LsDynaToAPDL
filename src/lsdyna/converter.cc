...
//     qDebug() << "set mode" << doc_section_ << "start reading node declaration";
//   }
...
//   ConverterSintax::test(textline, node, shell);
// }
...
//  * @return
//  */
// void sintax::lsdyna::ConverterSintax::test(const QString &textline, Node *node,
//                                            Shell *shell) {
//   switch (doc_section_) {
